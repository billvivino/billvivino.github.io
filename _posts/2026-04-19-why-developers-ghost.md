...
1.  First, the developer delays responding.
2.  Then they start answering narrowly instead of clearly.
3.  Then they give progress updates that are technically true but strategically empty.
4.  Then they stop volunteering bad news.
5.  Then they stop opening the messages as quickly.
6.  Then even reading the founder’s name produces stress.
